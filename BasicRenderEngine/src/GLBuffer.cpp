...
GLBufferMapping GLMappableBuffer::mapRange(int64_t offset, uint64_t size, GLbitfield access)
{
	return GLBufferMapping(*this, mapRangeRaw(offset, size, access), offset, size, access);
}
